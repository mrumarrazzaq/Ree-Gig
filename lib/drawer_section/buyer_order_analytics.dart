...
class BuyerOrderAnalytics extends StatefulWidget {
  const BuyerOrderAnalytics({Key? key}) : super(key: key);

  @override
  State<BuyerOrderAnalytics> createState() => _BuyerOrderAnalyticsState();
}

class _BuyerOrderAnalyticsState extends State<BuyerOrderAnalytics> {
  @override
